        ...
        <table border="1" >
            <tr>
                <th colspan="4"> Agregar persona</th>
                        <th> <a href="formulario.html">
                                <img src="img/extras/agreg.png" widht="50" height="50">
                    </a> </th>
                </tr>
                <tr bgcolor="#0027D8">
            <th> Nombre </th>
            ...
            <th>
                    <a href="editadatos.jsp?idPer=<%=idPer%>">
                        <img src="img/extras/edit.png" widht="50" height="50"></a>
                    <a href="eliminar.jsp?idPer=<%=idPer%>">
             <img src="img/extras/quit.png" widht="50" height="50"> </a>
            </th>
            </tr>
            </tr>
            <%
